...
@NamedQueries({
	...
	@NamedQuery(name="AttivitaSecondariaPacchetto.getPacchettiByAttivita", query="SELECT a FROM AttivitaSecondariaPacchetto a WHERE a.attivitaSecondariaBean = :attivita")
